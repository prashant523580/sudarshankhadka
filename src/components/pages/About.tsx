...
export default function AboutComponent() {
    return (
        <Section id={"About"}>
            ...
            <div className='py-10'>
                <div className='relaive flex justify-around items-center flex-wrap md:flex-nowrap'>

                    <div className='relative w-[30%] md:w-[40%] lg:w-[30%] h-96 '>
                        {/* <ParallaxBanner> */}
                    ...
                    <div  data-aos="fade-up" data-aos-duration="1000" className='relative h-64 lg:h-auto md:h-auto w-80'>
                        <Parallax speed={-5}>
                            ...
                            <div  className='bg-black overflow-hidden shadow-xl shadow-sky-700 rounded-md  px-5 py-5 absolute left-0 lg:-left-20 md:-left-20 top-0 -translate-y-[50%]'>
                                ...
                                <p  data-aos="fade-up" data-aos-duration="1400"  className='text-white'>A strong front office knowledge, excellent communication skills, and team management experience would be a valuable asset to any organization. Front office knowledge includes an understanding of reception, guest services, and administrative tasks that are essential for the smooth operation of a business..</p>
                            </div>
                        </Parallax>
                    </div>
                </div>
            <div className='px-10 space-y-4 py-3 my-8 text-white dark:text-gray-300'>
            <p data-aos="fade-up" data-aos-duration="1000">

            Effective communication skills are vital to building relationships with customers and colleagues, resolving conflicts, and providing clear direction. Team management involves leading, motivating, and coordinating a group of individuals towards common goals, which requires strong leadership, organization, and problem-solving abilities. A candidate with these skills can contribute to enhancing customer satisfaction, improving productivity, and achieving business objectives and i believe i possess these qualities. 
            </p>
