...
export default function Referencer() {
    return (
        <section className="text-gray-600 body-font">
            <div className="declear px-10 py-10  flex justify-center items-center flex-col">

                <h1 data-aos="fade-up" data-aos-duration="1000" className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-100 ">
